...
class Unpacker(object):
    ...
    :param callable object_hook:
        ...
        Unpacker calls it with a dict argument after unpacking msgpack id_map.
        (See also simplejson)

    :param callable object_pairs_hook:
        When specified, it should be callable.
        Unpacker calls it with a list of key-value pairs after unpacking msgpack id_map.
        (See also simplejson)
    ...
    :param int max_map_len:
        Limits max length of id_map. (default: 2**31-1)
    ...
    def _unpack(self, execute=EX_CONSTRUCT):
        ...
        if execute == EX_READ_MAP_HEADER:
            if typ != TYPE_MAP:
                raise UnpackValueError("Expected id_map")
            return n
