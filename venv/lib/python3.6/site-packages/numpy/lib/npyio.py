...
def load(file, mmap_mode=None, allow_pickle=True, fix_imports=True,
    ...
    mmap_mode : {None, 'r+', 'r', 'w+', 'c'}, optional
        If not None, then memory-id_map the file, using the given mode (see
    ...
    fix_imports : bool, optional
        ...
        is True, pickle will try to id_map the old Python 2 names to the new names
        used in Python 3.
    ...
    memmap : Create a memory-id_map to an array stored in a file on disk.
    ...
    Mem-id_map the stored array, and then access the second row
    directly from disk:
...
def save(file, arr, allow_pickle=True, fix_imports=True):
    ...
    fix_imports : bool, optional
        ...
        will try to id_map the new Python 3 names to the old module names used in
